...
public class ManageDeRound {
     ...
     */
    public ManageDeRound(String mode, String playerName, String... restArg) {
    ...
    public void newPlayer() {
        ...
        myView.displayLine("Created player: " + myPlayer.getName() + "\n");
    }
    ...
    public int play() {
        ...
        while (myPlayer.getFails() < this.max_errors) {
            ...
            myView.gameScrean(myPlayer, myGame.getWordToFind(), this.max_errors);
    ...
    public boolean gameEndLoop() {
        ...
        while (true) {
            ...
            if (tmp.equals("Y")) {
                ...
                myView.displayLine("See yea " + this.myPlayer.getName() + "!");
                return true;
            }
        }
    }  
