 ...
 * Control of pop up no 1
 * Asks player to choose to play in GUI or console version
...
public class AskWindow implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {   
        btn0.setOnAction(e -> {btn_click(btn0_action);});
        btn1.setOnAction(e -> {btn_click(btn1_action);});   
    }    
