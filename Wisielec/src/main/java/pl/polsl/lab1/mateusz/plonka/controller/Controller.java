...
public class Controller {
    ...
    public Controller(String[] args){
        ...
        //Exception if given args are bad
        ...
        else
        {
            ...
            if(args[0].equals("0")) this.mode = 0;
            else if(args[0].equals("1")) this.mode = 1;
            else needToAsk = true;
            ...
            if(needToAsk) this.askForArgs();
        } 
    }
    
    
    /**
     * Method asks for main params if they were not given or the game was restarted
     */
    public void askForArgs(){
        ...
        while(true){
            tmp = myView.readLine();
            if(tmp.equals("0")) {this.mode = 0; break;}
            else if(tmp.equals("1")) {this.mode = 1; break;}
            else 
            {  
                View.displayLine("\nChoose Mode:");
                View.displayLine("[0] Reads bank of words from file");
        ...
        while(true){
          ...
          if(!this.playerName.equals(""))  break;
        }
    ...
    public void upgrateGame(){
        ...
        while(true){
           ...
           if(!tmp.equals("exit")) {if(myGame.addWordToBank(tmp)){counter++;}}
            else break;
        }
     ...
     * @return True when operation is succeeded, false when HangmanException is cought
     */
    ...
    public int play(){
        ...
        while (myPlayer.getFails() < this.max_errors) {
            ...
            View.gameScrean(myPlayer, myGame.getWordToFind(), myGame.getChosenWord().length(), this.max_errors);
            ...
            if ((!myPlayer.getAlreadyTried().contains(typed)) && (typed != '#')) {
                ...
                if (myGame.getChosenWord().contains(String.valueOf(typed))) {
                    ...
                    while (index >= 0) {
                        myGame.getWordToFind()[index] = typed;
           ...
           if(myGame.compareWords()) return 1;
        }  
        return 0;
    }
    ...
    public static void main(String[] args) {
        ...
        Controller myControl = new Controller(args);
        ...
        while(!gameOver){
            ...
            while(true){
                ...
                //End of game
                    ...
                    View.displayLine("See yea " + myControl.getMyPlayer().getName() + "!");
                    gameOver = true;
                    break;
                }
            }   
